...
As the title of this post suggests, the alternative is a fundamental shift in how we think about code, focusing on writing well-reasoned, well-abstracted and well-tested data applications, rather than scripts. In doing this, we should aim to adopt all of the usual best practices developed over years in the field of software engineering. Data engineering is ultimately a specialised subset of software engineering focused on systems which collect, process and store data. Broadly speaking, all of the keys to successful software delivery and equally valid and equally applicable to successful data delivery.
